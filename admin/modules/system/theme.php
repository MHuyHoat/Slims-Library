...
if($_SESSION['uid'] == '1'){
  ...
  foreach ($dir_tree as $dir) {
    ...
    $output = '<div class="theme-item m-2" >';
    ...
    $output .= '<img class="card-img-top rounded" src="'.SWB.'template/'. $dir . '/'.$preview.'"  height="150px"  />';
    $output .= '</div>';
